...
public class Effect : MonoBehaviour
{
    ...
    public void EndTrigger()
    {
        ...
        else
        {
            ...
            if (targetPlayer.isPlayer)
            {
                if (sourceCard.cardData.damageType == CardData.DamageType.Fire && targetPlayer.isPlayer)
                    damage /= 2;
                if (sourceCard.cardData.damageType == CardData.DamageType.Ice && !targetPlayer.isPlayer)
                    damage /= 2;
            }
    ...
    internal void PlayDestuctballSound()
    {
